...
- Passive tree: exact Mythos costs, node counts per branch, trunk node list, and specific Mythic card designs per Blessing (Section 8) — rule shape settled, content and numbers aren't
